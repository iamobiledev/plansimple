 ...
 *
 * All functions operate on points in "sheet pixels" — the PDF page's
 * coordinate space at render scale 1. Conversion to real-world units lives
 * in scale.ts.
 */
import type { Point, MeasurementType } from "../types";
