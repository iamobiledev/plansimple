...
describe("computePixelsPerUnit", () => {
  it("divides pixel distance by real length", () => {
    // A 400px calibration line over a 20 ft dimension => 20 px/ft
...
describe("pixelsToLength / pixelsToArea", () => {
  it("converts lengths", () => {
    expect(pixelsToLength(100, 20)).toBe(5); // 100px at 20px/ft = 5ft
  });

  it("converts areas with squared scale", () => {
    // 20 px/ft => 400 px² per sq ft
